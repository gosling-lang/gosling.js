...
import { EX_SPEC_SPATIAL, EX_SPEC_SPATIAL_MINIMAL, EX_SPEC_SPATIAL_MULTIPLE_TRACKS, EX_SPEC_SPATIAL_SUPERIMPOSITION } from './spatial-layout';
...
export const JsonExampleSpecs = {
    ...
    EX_SPEC_SPATIAL_SUPERIMPOSITION,
};
