    ...
    ideogramTracks.push(
        {
            ...
            x: { ...EXAMPLE_STACKED_AREA.x, domain: { chromosome: d.chr }, linkID: `link-${i}` },
            width: d.width,
            zoomable: false
        },
        {
            ...EXAMPLE_IDEOGRAM_TRACK,
            x: { ...EXAMPLE_IDEOGRAM_TRACK.x, domain: { chromosome: d.chr }, axis: undefined, linkID: `link-${i}` },
            height: 24,
            width: d.width,
            zoomable: false
        }
...
export const EXAMPLE_IDEOGRAM: GeminiSpec = {
    layout: { direction: 'vertical', type: 'linear', rowSize: [60, 24, 60, 24, 60, 24, 60, 24, 60, 24, 60, 24] },
