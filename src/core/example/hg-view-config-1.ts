const example = {
    ...
    zoomLocks: {
        ...
        locksDict: {
            all: {
                uid: 'all',
                'view-1': [124625310.5, 124625310.5, 249250.621],
                'view-2': [124625310.5, 124625310.5, 249250.621],
                'view-3': [124625310.5, 124625310.5, 249250.621]
            }
        }
    },
    locationLocks: {
        locksByViewUid: {
            ...
            'view-2': { x: { lock: 'top', axis: 'x' }, y: { lock: 'bottom', axis: 'x' } },
            'view-3': { x: { lock: 'bottom', axis: 'y' } }
        },
        locksDict: {
            top: {
                uid: 'top',
